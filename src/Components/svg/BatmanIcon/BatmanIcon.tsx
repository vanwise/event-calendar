  ...
  return (
    <svg
      ...
      <path
        ...
        fill="#393c54"
      />
      <path d="M46.13 57.75 55.88 60a5 5 0 1 1-9.75-2.21Z" fill="#fff" />
      <circle cx="51" cy="59.02" r="2.72" fill="#393c54" />
      <path
        d="m56.36 60.07-10.72-2.44"
        className="cls-9"
        opacity=".4"
        stroke="#515570"
        strokeWidth="2"
      ...
      />
      <path d="M81.87 57.75 72.12 60a5 5 0 1 0 9.75-2.21Z" fill="#fff" />
      <circle cx="77.06" cy="59.01" r="2.63" fill="#393c54" />
      <path
        d="m71.64 60.07 10.72-2.44"
        className="cls-9"
        opacity=".4"
        stroke="#515570"
        strokeWidth="2"
